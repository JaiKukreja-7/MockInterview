    ...
    <div style={{
      ...
      <motion.div 
        ...
        style={{
          ...
          width: '100%',
          maxWidth: '420px',
          boxShadow: '0 25px 80px rgba(0,0,0,0.3), 0 0 0 0.5px rgba(124,58,237,0.1)',
          position: 'relative',
          zIndex: 1
        }}
        className="mx-4"
      >
        ...
        <h1 className="text-3xl font-bold mb-2" style={{ color: 'var(--text-primary)' }}>{isSignUp ? 'Create an Account' : 'Welcome Back'}</h1>
        <p style={{ color: 'var(--text-secondary)' }}>{isSignUp ? 'Join the AI Mock Interview Platform' : 'Ready for your next mock interview?'}</p>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="w-full rounded-lg py-3 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
              style={{ background: 'rgba(255,255,255,0.06)', border: '0.5px solid rgba(255,255,255,0.1)', color: 'var(--text-primary)' }}
      ...
      <div className="mt-6 flex items-center">
        ...
        <span className="px-4 text-xs uppercase font-medium" style={{ color: 'var(--text-muted)' }}>Or continue with</span>
        <div className="flex-1" style={{ borderTop: '1px solid var(--border-color)' }}></div>
      </div>
      ...
      <div className="mt-6 flex flex-col gap-3">
        <button 
          ...
          type="button" 
          className="w-full font-medium py-3 rounded-lg transition-all active:scale-[0.98] flex items-center justify-center space-x-2"
          style={{ background: 'rgba(255,255,255,0.05)', border: '0.5px solid rgba(255,255,255,0.1)', color: 'var(--text-primary)' }}
        >
